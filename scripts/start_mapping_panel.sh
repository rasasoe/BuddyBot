...
FOLLOW_CENTER_GAIN="$(float_param_value "${BUDDYBOT_FOLLOW_CENTER_GAIN:-0.00065}")"
FOLLOW_TARGET_HEIGHT="$(float_param_value "${BUDDYBOT_FOLLOW_TARGET_HEIGHT:-0.98}")"
FOLLOW_MAX_LINEAR="$(float_param_value "${BUDDYBOT_FOLLOW_MAX_LINEAR:-0.42}")"
FOLLOW_MAX_ANGULAR="$(float_param_value "${BUDDYBOT_FOLLOW_MAX_ANGULAR:-0.055}")"
...
FOLLOW_ANGULAR_ACCEL="$(float_param_value "${BUDDYBOT_FOLLOW_ANGULAR_ACCEL:-0.06}")"
...
FOLLOW_VISIBLE_FORWARD_MAX_HEIGHT="$(float_param_value "${BUDDYBOT_FOLLOW_VISIBLE_FORWARD_MAX_HEIGHT:-0.99}")"
