...
FOLLOW_FORWARD_YAW_TRIM="$(float_param_value "${BUDDYBOT_FOLLOW_FORWARD_YAW_TRIM:-0.0}")"
...
VOICE_CONTINUOUS_MAX_SEC="${BUDDYBOT_VOICE_CONTINUOUS_MAX_SEC:-10.0}"
