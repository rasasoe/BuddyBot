...
VOICE_PAUSE_THRESHOLD="${BUDDYBOT_VOICE_PAUSE_THRESHOLD:-0.55}"
...
VOICE_ENERGY_THRESHOLD="${BUDDYBOT_VOICE_ENERGY_THRESHOLD:-180}"
VOICE_MAX_ENERGY_THRESHOLD="${BUDDYBOT_VOICE_MAX_ENERGY_THRESHOLD:-450}"
VOICE_AMBIENT_ADJUST_DURATION="${BUDDYBOT_VOICE_AMBIENT_ADJUST_DURATION:-0.4}"
