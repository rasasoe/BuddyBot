...
FOLLOW_HEIGHT_GAIN="$(float_param_value "${BUDDYBOT_FOLLOW_HEIGHT_GAIN:-0.006}")"
FOLLOW_CENTER_GAIN="$(float_param_value "${BUDDYBOT_FOLLOW_CENTER_GAIN:-0.0012}")"
FOLLOW_TARGET_HEIGHT="$(float_param_value "${BUDDYBOT_FOLLOW_TARGET_HEIGHT:-0.72}")"
FOLLOW_MAX_LINEAR="$(float_param_value "${BUDDYBOT_FOLLOW_MAX_LINEAR:-0.30}")"
FOLLOW_MAX_ANGULAR="$(float_param_value "${BUDDYBOT_FOLLOW_MAX_ANGULAR:-0.10}")"
FOLLOW_MIN_LINEAR="$(float_param_value "${BUDDYBOT_FOLLOW_MIN_LINEAR:-0.22}")"
FOLLOW_COMMAND_RATE="$(float_param_value "${BUDDYBOT_FOLLOW_COMMAND_RATE:-10.0}")"
FOLLOW_LINEAR_ACCEL="$(float_param_value "${BUDDYBOT_FOLLOW_LINEAR_ACCEL:-0.30}")"
...
FOLLOW_VISIBLE_FORWARD="$(float_param_value "${BUDDYBOT_FOLLOW_VISIBLE_FORWARD:-0.22}")"
FOLLOW_VISIBLE_FORWARD_CENTER_DEADZONE="${BUDDYBOT_FOLLOW_VISIBLE_FORWARD_CENTER_DEADZONE:-120}"
FOLLOW_VISIBLE_FORWARD_MAX_HEIGHT="$(float_param_value "${BUDDYBOT_FOLLOW_VISIBLE_FORWARD_MAX_HEIGHT:-0.82}")"
