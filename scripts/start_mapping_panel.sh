...
FOLLOW_TARGET_HEIGHT="$(float_param_value "${BUDDYBOT_FOLLOW_TARGET_HEIGHT:-0.75}")"
...
FOLLOW_VISIBLE_FORWARD="$(float_param_value "${BUDDYBOT_FOLLOW_VISIBLE_FORWARD:-0.08}")"
FOLLOW_VISIBLE_FORWARD_CENTER_DEADZONE="${BUDDYBOT_FOLLOW_VISIBLE_FORWARD_CENTER_DEADZONE:-120}"
FOLLOW_USE_LIDAR_DISTANCE_PARAM="$(bool_param_value "${BUDDYBOT_FOLLOW_USE_LIDAR_DISTANCE:-1}")"
