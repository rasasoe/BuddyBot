...
FOLLOW_CENTER_GAIN="$(float_param_value "${BUDDYBOT_FOLLOW_CENTER_GAIN:-0.0008}")"
FOLLOW_TARGET_HEIGHT="$(float_param_value "${BUDDYBOT_FOLLOW_TARGET_HEIGHT:-0.90}")"
FOLLOW_MAX_LINEAR="$(float_param_value "${BUDDYBOT_FOLLOW_MAX_LINEAR:-0.42}")"
FOLLOW_MAX_ANGULAR="$(float_param_value "${BUDDYBOT_FOLLOW_MAX_ANGULAR:-0.07}")"
...
FOLLOW_ANGULAR_ACCEL="$(float_param_value "${BUDDYBOT_FOLLOW_ANGULAR_ACCEL:-0.08}")"
...
FOLLOW_VISIBLE_FORWARD_MAX_HEIGHT="$(float_param_value "${BUDDYBOT_FOLLOW_VISIBLE_FORWARD_MAX_HEIGHT:-0.94}")"
