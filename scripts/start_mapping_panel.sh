...
VOICE_BACKWARD_YAW_TRIM="${BUDDYBOT_VOICE_BACKWARD_YAW_TRIM:--0.010}"
VOICE_STRAFE_LEFT_YAW_TRIM="${BUDDYBOT_VOICE_STRAFE_LEFT_YAW_TRIM:-0.035}"
VOICE_STRAFE_RIGHT_YAW_TRIM="${BUDDYBOT_VOICE_STRAFE_RIGHT_YAW_TRIM:--0.035}"
