...
class FollowControllerNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('center_x_gain', 0.00065)  # Angular velocity gain for center offset
        self.declare_parameter('height_gain', 0.010)    # Linear velocity gain for box height
        self.declare_parameter('target_height_ratio', 0.98)  # Target box height as fraction of image
        self.declare_parameter('max_linear_velocity', 0.42)  # normalized 0-1 (pico maps directly to PWM)
        self.declare_parameter('max_angular_velocity', 0.055)  # normalized 0-1
        ...
        self.declare_parameter('angular_accel_limit', 0.06)  # normalized units per second
        ...
        self.declare_parameter('visible_forward_max_height_ratio', 0.99)
